...
fig_dir = '/Users/aklimasewski/Documents/figs/'
...
def build_model():
    ...
    model = Sequential()
    model.add(layers.Dense(12,activation='sigmoid', input_shape=(train_data.shape[1],)))
    ...
    model.compile(optimizer=optimizers.Adam(lr=2e-3),loss=loss,metrics=['mae','mse']) 
...
plt.savefig('/Users/aklimasewski/Documents/figs/prediction_hist_i_' + str(testi) + '_n_' + str(num_dist))
plt.show()
#%%
####
plt.figure()
