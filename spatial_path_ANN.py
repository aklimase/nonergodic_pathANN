...
if az == True:
    ...
    # az12,az21,distance = geodesic.inv(train_data1[:,15],train_data1[:,14],train_data1[:,13],train_data1[:,12])
    # az12_test,az21_test,distance_test = geodesic.inv(test_data1[:,15],test_data1[:,14],test_data1[:,13],test_data1[:,12])

    az12,az21,distance = geodesic.inv(train_data1[:,16],train_data1[:,15],train_data1[:,14],train_data1[:,13])
    az12_test,az21_test,distance_test = geodesic.inv(test_data1[:,16],test_data1[:,15],test_data1[:,14],test_data1[:,13])

# midpoint = np.asarray([(train_data1[:,12]+train_data1[:,14])/2.,(train_data1[:,13]+train_data1[:,15])/2.]).T
# midpoint_test = np.asarray([(test_data1[:,12]+test_data1[:,14])/2.,(test_data1[:,13]+test_data1[:,15])/2.]).T
    ...
    feature_names = np.concatenate([feature_names,np.asarray(['forward_az','midpointlat','midpointlon'])], axis = 0)
    # ######
